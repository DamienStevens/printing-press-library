...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("GRANOLA_STATE_DIR", "")
	t.Setenv("GRANOLA_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		...
		"granola-pp-cli help items",
		"granola-pp-cli sync",
		"granola-pp-cli profile list",
		"granola-pp-cli feedback list",
		"granola-pp-cli which",
		"granola-pp-cli agent-context",
		"granola-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"granola-pp-cli teach",
		"granola-pp-cli recall",
		"granola-pp-cli learnings",
		"granola-pp-cli teach-pattern",
		"granola-pp-cli teach-lookup",
		"granola-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("granola-pp-cli")); err == nil {
