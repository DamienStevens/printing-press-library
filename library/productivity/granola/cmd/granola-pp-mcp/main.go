...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/granola/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("GRANOLA_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "granola-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
