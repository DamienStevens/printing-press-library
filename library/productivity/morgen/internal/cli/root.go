...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "morgen-pp-cli",
		Short: "Manage morgen resources via the morgen API",
		Long: `Manage morgen resources via the morgen API.
...
Run 'morgen-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("morgen-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'morgen-pp-cli profile list')")
