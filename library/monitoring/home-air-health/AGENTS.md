# Home Health Printed CLI Agent Guide

This directory is a generated `home-air-health-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
home-air-health-pp-cli doctor --json
home-air-health-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
home-air-health-pp-cli which "<capability>" --json
home-air-health-pp-cli <command> --help
```
...
```bash
home-air-health-pp-cli <command> --agent
```
...
```bash
home-air-health-pp-cli <command> --help
home-air-health-pp-cli <command> --dry-run --agent
```
