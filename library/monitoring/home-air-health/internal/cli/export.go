...
large datasets as it has no memory pressure.`,
  ...
  home-air-health-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  home-air-health-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  home-air-health-pp-cli export <resource> --format jsonl | jq '.id'`,
