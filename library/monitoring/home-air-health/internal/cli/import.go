...
but do not stop the import.`,
  ...
  home-air-health-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  home-air-health-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | home-air-health-pp-cli import <resource> --input -`,
