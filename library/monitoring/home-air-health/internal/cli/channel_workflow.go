...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  home-air-health-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  home-air-health-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"alerts", "devices", "nodes"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  home-air-health-pp-cli workflow status

  # Show status as JSON
  home-air-health-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("home-air-health-pp-cli")
			}
