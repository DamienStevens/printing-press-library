...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/monitoring/home-air-health/internal/readings"
	"github.com/mvanhorn/printing-press-library/library/monitoring/home-air-health/internal/source"
	"github.com/mvanhorn/printing-press-library/library/monitoring/home-air-health/internal/source/airthings"
	"github.com/mvanhorn/printing-press-library/library/monitoring/home-air-health/internal/source/iqair"
	"github.com/mvanhorn/printing-press-library/library/monitoring/home-air-health/internal/source/mocreo"
	"github.com/mvanhorn/printing-press-library/library/monitoring/home-air-health/internal/store"
...
const hhDBName = "home-air-health-pp-cli"
...
func newCollectCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  home-air-health-pp-cli collect\n  home-air-health-pp-cli collect --since 168h   # backfill a week of MOCREO\n  home-air-health-pp-cli collect --json",
