...
Resource scoping:
  ...
  home-health-pp-cli sync

  # Sync specific resources only
  home-health-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  home-health-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  home-health-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  home-health-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  home-health-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/home-health-pp-cli/data.db)")
