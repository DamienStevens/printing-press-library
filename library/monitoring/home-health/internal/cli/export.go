...
large datasets as it has no memory pressure.`,
  ...
  home-health-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  home-health-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  home-health-pp-cli export <resource> --format jsonl | jq '.id'`,
