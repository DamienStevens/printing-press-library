...
but do not stop the import.`,
  ...
  home-health-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  home-health-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | home-health-pp-cli import <resource> --input -`,
