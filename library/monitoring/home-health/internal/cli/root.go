...
Run 'home-health-pp-cli collect' to pull the latest readings from every
configured source into the local SQLite history, then 'home-health-pp-cli
...
Run 'home-health-pp-cli doctor' to verify credentials and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("home-health-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'home-health-pp-cli profile list')")
