...
func feedbackFilePath() (string, error) {
	...
	dir := filepath.Join(home, ".local", "share", "home-health-pp-cli")
...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "home-health-pp-cli/feedback")
...
func newFeedbackCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Feedback is captured locally first at ~/.local/share/home-health-pp-cli/feedback.jsonl.
...
func newFeedbackListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  home-health-pp-cli feedback list
  home-health-pp-cli feedback list --limit 5
  home-health-pp-cli feedback list --json`,
