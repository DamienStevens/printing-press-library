# AWS Billing Intelligence Printed CLI Agent Guide

This directory is a generated `aws-billing-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
aws-billing-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
aws-billing-pp-cli which "<capability>" --json
aws-billing-pp-cli <command> --help
```
...
```bash
aws-billing-pp-cli <command> --agent
```
...
```bash
aws-billing-pp-cli <command> --help
aws-billing-pp-cli <command> --dry-run --agent
```
