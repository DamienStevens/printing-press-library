...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/cloud/aws-billing/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "aws-billing-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
