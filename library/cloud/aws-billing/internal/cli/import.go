...
but do not stop the import.`,
  ...
  aws-billing-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  aws-billing-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | aws-billing-pp-cli import <resource> --input -`,
