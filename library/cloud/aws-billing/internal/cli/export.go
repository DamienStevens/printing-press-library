...
large datasets as it has no memory pressure.`,
  ...
  aws-billing-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  aws-billing-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  aws-billing-pp-cli export <resource> --format jsonl | jq '.id'`,
